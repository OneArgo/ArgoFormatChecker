...
public final class ArgoNVSReferenceTable {
	...
	public static enum RELEVANT_TABLES {
		...
		DATA_STATE_INDICATOR("DATA_STATE_INDICATOR", "R06"), ARGO_WMO_INST_TYPE("ARGO_WMO_INST_TYPE", "R08"),
		POSITIONING_SYSTEM("POSITIONING_SYSTEM", "R09"), TRANS_SYSTEM("TRANS_SYSTEM", "R10"),
		VERTICAL_SAMPLING_SCHEME("VERTICAL_SAMPLING_SCHEME", "R16"), STATUS("STATUS", "R19"),
		GROUNDED("GROUNDED", "R20"), PLATFORM_FAMILY("PLATFORM_FAMILY", "R22"), SENSOR("SENSOR", "R25"),
		SENSOR_MAKER("SENSOR_MAKER", "R26"), SENSOR_MODEL("SENSOR_MODEL", "R27"),
