...
public class ResultsFile
{
  ...
  private static final Logger log = LogManager.getLogger("ResultsFile");
   ...
   public ResultsFile (boolean doXml, String resultsFileName, 
                       String fcVersion, String spVersion,
                       String inputFileName)
      throws IOException, XMLStreamException
   {
      out = new PrintWriter
         (new BufferedWriter
          (new java.io.FileWriter(resultsFileName)));      
      ...
      if (doXml) {
         ...
         out.println("VERSION-INFO: FileChecker = '"+fcVersion+
                     "' Specification = '"+spVersion+"'");
  ...
  public void openError(Exception e) throws XMLStreamException
      ...
      throws XMLStreamException
   {
      ...
      if (doXml) {
         ...
         out.println("ERROR: "+type+" validation failed: "+
   ...
   public void metaData (String dacName, ArgoDataFile argo, 
                         boolean formatPassed, boolean doPsalStats)
      throws XMLStreamException
   {
      ...
      case METADATA: str = "Argo meta-data"; break;
      case BIO_PROFILE: str = "B-Argo profile"; break;
      case BIO_TRAJECTORY: str = "B-Argo trajectory"; break;
      case PROFILE: str = "Argo profile"; break;
      case TECHNICAL: str = "Argo technical data"; break;
      case TRAJECTORY: str = "Argo trajectory"; break;
      default: str = "File type not determined"; break;
      }
   ...
   public void addMetaPsalStats (ArgoProfileFile argo)
      throws XMLStreamException
   {
   ...
   public void errorsAndWarnings(ArgoDataFile argo)
      throws XMLStreamException
   {
      if (doXml) {
         xml.writeStartElement("errors");
      ...
      if (! doXml) { out.println("FORMAT-WARNINGS: end"); }
   ...
   private void metaStr (ArgoDataFile argo, String var, String fmt)
      throws XMLStreamException
   {
      String str = argo.readString(var);
      if (str == (String) null) { str = "null"; }
   ...
   private void metaStrArray (ArgoDataFile argo, String var, String fmt)
      throws XMLStreamException
   {
   ...
   private void metaIntArray (ArgoDataFile argo, String var, DecimalFormat fmt)
      throws XMLStreamException
   {
   ...
   private void metaDoubleArray (ArgoDataFile argo, String var, DecimalFormat fmt)
      throws XMLStreamException
   {
   ...
   private void metaDoubleValArray (double[] arr, String var, DecimalFormat fmt)
      throws XMLStreamException
   {
      if (doXml) {
         xml.writeStartElement(var);
   ...
   private void metaTimeArray (ArgoDataFile argo, String var, String fmt)
         throws XMLStreamException
   {
      double[] arr = argo.readDoubleArr(var);
   ...
   private void metaTrajectoryParameters (ArgoDataFile argo)
      throws XMLStreamException
   {
      int n_param = argo.getDimensionLength("N_PARAM");
      if (n_param < 0) return;
