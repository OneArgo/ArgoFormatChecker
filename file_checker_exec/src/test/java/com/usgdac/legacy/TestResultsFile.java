...
public class TestResultsFile {
	...
	public static void main(String args[])
		...
		if (!(new File(specDirName).isDirectory())) {
			stderr.println("ERROR: Specification directory is not a directory ('" + specDirName + "')");
		...
		results = new ResultsFile(doXml, outFileName, fcVersion, spVersion, inFileName);
		...
		log.debug("Test 'not an Argo file' output: in, out = '{}', '{}'", inFileName, outFileName);
		...
		log.debug("Test 'no specification' output: in, out = '{}', '{}'", inFileName, outFileName);
		...
		log.debug("Test 'format invalid' output: in, out = '{}', '{}'", inFileName, outFileName);
