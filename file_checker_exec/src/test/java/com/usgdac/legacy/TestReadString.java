	...
	public static void main(String args[]) throws IOException {
		...
		for (String inFileName : inFileList) {
...

			{
				...
				String[] VAR = { "DATA_TYPE", "FORMAT_VERSION", "HANDBOOK_VERSION", "DIRECTION", "DATA_MODE",
						"JULD_QC" };
...

			{
				...
				String[] VAR = { "PLATFORM_NUMBER", "PROJECT_NAME", "PI_NAME", "DATA_STATE_INDICATOR", "WMO_INST_TYPE",
						"DATA_CENTRE" };
...

			{
				...
				String[] VAR = { "STATION_PARAMETERS", "HISTORY_INSTITUTION", "HISTORY_DATE", "HISTORY_PARAMETER" };
...

			{
				...
				String[] VAR = { "PARAMETER", "SCIENTIFIC_CALIB_EQUATION", "SCIENTIFIC_CALIB_DATE",
