      ...
      throws IOException
   {
      ...
      for (String file : args) {
         ...
         if (argo.fileType() != FileType.TECHNICAL) {
            stdout.println("Who you trying to kid?  This isn't a tech file.");
            continue;
         }
         ...
         int nMessage = 0;
         for (String str: tech.formatErrors()) {
            stdout.println(file+": ERROR:   "+str);
            nMessage++;
         }

         for (String str: tech.formatWarnings()) {
         ...
         //..reset
         tech.clearFormatErrors();
         tech.clearFormatWarnings();
